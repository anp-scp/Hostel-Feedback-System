				...
				if(rs.next())
				{
					if(rs.getInt(4) == 0)
					{
						if(rs.getString(1).equals(uid))
						{
								    		...
								    		<div class="message col-sm-4">
								    			<div class="card text-center">
												  ...
												  <div class="card-body text-center">
												    <form class="pass" action="addAdmin.jsp" method="post">
												    	<div class="form-group">
												    		<input type="text" class="form-control mx-auto" name="name" required="required" placeholder="Enter your name name" value="${fn.escapeXml(param.name) }">
							...
							{
								alert = "The link you tried was expired.... <a href='/hostelFeedback/admin/activation/resend.jsp?user=" + user + "' > Click here to resend the mail.</a>";
								session.setAttribute("alert", alert);
								ps = conn.prepareStatement("update admin set verified = 0,otp = '-1',otpTime = -1 where email = ?");
								ps.setString(1, user);
								ps.executeUpdate();
								ps.close();
								conn.close();
